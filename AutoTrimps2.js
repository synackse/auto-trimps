var ATversion = 'Zek v5.1.0',
    ...
    basepath = 'https://synackse.github.io/AutoTrimps/', //Link to your own Github here if you forked!
    modulepath = 'modules/';
...
function initializeAutoTrimps() {
    ...
    var script = document.createElement('script');
    script.src = 'https://synackse.github.io/AutoTrimps/Graphs.js';
    document.head.appendChild(script);
...
function mainLoop() {
	...
	if (getPageSetting('automapsalways') == true && autoTrimpSettings.AutoMaps.value != 1) autoTrimpSettings.AutoMaps.value = 1;
        ...
        if ((getPageSetting('darmourmagic') > 0 && typeof game.global.dailyChallenge.empower == 'undefined' && typeof game.global.dailyChallenge.bloodthirst == 'undefined' && (typeof game.global.dailyChallenge.bogged !== 'undefined' || typeof game.global.dailyChallenge.plague !== 'undefined' || typeof game.global.dailyChallenge.pressure !== 'undefined')) || (getPageSetting('carmourmagic') > 0 && (challengeActive("Toxicity") || challengeActive("Nom")))) armourmagic();
	...
	if (getPageSetting('Rautomapsalways') == true && autoTrimpSettings.RAutoMaps.value != 1) autoTrimpSettings.RAutoMaps.value = 1;
        ...
        if ((getPageSetting('Rdarmourmagic') > 0 && typeof game.global.dailyChallenge.empower == 'undefined' && typeof game.global.dailyChallenge.bloodthirst == 'undefined' && (typeof game.global.dailyChallenge.bogged !== 'undefined' || typeof game.global.dailyChallenge.plague !== 'undefined' || typeof game.global.dailyChallenge.pressure !== 'undefined')) || (getPageSetting('Rcarmourmagic') > 0 && (game.global.challengeActive == 'Toxicity' || game.global.challengeActive == 'Nom'))) Rarmourmagic();
