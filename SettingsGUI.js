...
function initializeAllSettings() {
    ...
    //Line 1
    createSetting('BuyArmorNew', ['Armor: Buy Neither', 'Armor: Buy Both', 'Armor: Prestiges', 'Armor: Levels'], 'AutoBuys Prestiges and Levels up the most cost efficient Armour available. Gymystic buying is controlled under this setting\'s prestige option', 'multitoggle', 1, null, "Gear"); //This should replace the two below
    ...
    createSetting('CapEquiparm', 'Armor Level Cap', 'Do not level Armour past this number. Helps stop wasting metal when the script levels-up equip High, only to prestige right after. Recommended value: earlygame 10, lategame: 100. Disable with -1 or 0. <b>NEW:</b> Also sub-caps to 10% of your number during liquified or overkilled(under 25sec) zones. This does not mean the script always hits the cap. Your Equip will now always be leveled to at least 2 since its the most effective level. It will only be leveled however if you dont have enoughHealth. But During Spire, everything will be leveled up to the cap.<br><b>Hidden var: </b>MODULES[\\"equipment\\"].capDivisor = 10; //number to divide your normal cap by.', 'value', 10, null, 'Gear');
    ...
    createSetting('always2', 'Always Level 2', 'Always buys level 2 of weapons and armour regardless of efficiency', 'boolean', false, null, "Gear");
    ...
    createSetting('Requip2', 'AE: 2', 'Always buys level 2 of weapons and armour regardless of efficiency', 'boolean', true, null, "Gear");
    ...
    createSetting('spireshitbuy', 'Buy Gear in Spire', 'Will buy Weapons and Armour in Spire regardless of your H:D ratio. Respects your max gear level and ignore spires setting. ', 'boolean', false, null, 'Spire');
